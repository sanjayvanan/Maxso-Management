        ...
        <aside className={`${styles.sidebarContainer} ${isOpen ? 'translate-x-0 md:ml-0' : '-translate-x-full md:-ml-64'}`}>
            ...
            <nav className={styles.sidebarNav}>
                ...
                <div className="mt-2 text-white">
                    <div className="flex items-center justify-between px-4 py-3 rounded-lg text-sm font-medium hover:bg-red-900/40 cursor-pointer">
                    ...
                    <div className={styles.sidebarSubmenu}>
                        <Link
                            to="/admin/users"
                            className={currentPath.includes('/admin/users') ? styles.sidebarSubLinkActive : styles.sidebarSubLink}
                        >
                        ...
                        <Link
                            to="/referrals"
                            className={currentPath.includes('/referrals') ? styles.sidebarSubLinkActive : styles.sidebarSubLink}
                        >
                ...
                <Link to="/plans" className={styles.sidebarLink}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
                    Plans
                </Link>
                <Link to="/transactions" className={styles.sidebarLink}>
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"></path></svg>
                    Transactions
                </Link>
                <Link to="/level-config" className={styles.sidebarLink}>
